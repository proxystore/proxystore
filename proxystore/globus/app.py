"""Create [`GlobusApp`][globus_sdk.experimental.globus_app.GlobusApp] instances."""  # noqa: E501
...
def _get_app_name() -> str:
    ...
    return f'proxystore-client-{network_name}'
...
def get_globus_app() -> GlobusApp:
    ...
    [`ClientApp`][globus_sdk.experimental.globus_app.ClientApp] using
    [`get_client_app()`][proxystore.globus.app.get_client_app]. Otherwise
    returns a [`UserApp`][globus_sdk.experimental.globus_app.UserApp] using
...
def get_user_app() -> UserApp:
    ...
    The [`UserApp`][globus_sdk.experimental.globus_app.UserApp] will
