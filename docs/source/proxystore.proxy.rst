...
.. class:: proxystore.proxy.Proxy(factory: proxystore.factory.BaseFactory) 
   ...
   The factory returns the underlying object when called, i.e. ‘resolves’ the proxy. The proxy does not call the factory until the first access to the proxy (hence, the lazy aspect of the proxy).
   ...
   :type factory: :class:`BaseFactory <proxystore.factory.BaseFactory>`

   :raises TypeError: if `factory` is not an instance of :class:`BaseFactory <proxystore.factory.BaseFactory>`.
